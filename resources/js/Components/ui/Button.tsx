...
const buttonClasses = "focus:outline-none font-medium rounded-md text-sm";
...
const colorClasses = {
    ...
    alternative: "text-gray-900 bg-white border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700",
    dark: "text-white bg-gray-800 hover:bg-gray-900 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700",
    ...
    purple: "text-white bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:ring-purple-300 mb-2 dark:bg-purple-600 dark:hover:bg-purple-700 dark:focus:ring-purple-900",
};
...
export default function Button({ children, color = 'default', className = '', size = 'md', ...props }: ButtonProps) {
    const btnClasses = clsx(buttonClasses, colorClasses[color], sizeClasses[size], className);
